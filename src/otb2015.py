...
def download_otb(args, overwrite=False):
    ...
    for per_otb50 in otb50:
        filename = args.download_dir + '\\' + per_otb50 + '.zip'
    ...
    for per_otb100 in otb100:
        filename = args.download_dir + '\\' + per_otb100 + '.zip'
        if not os.path.isfile(filename):
    ...
    # os.rename(os.path.join(args.download_dir,'Jogging'),os.path.join(args.download_dir,'Jogging-1'))
    # os.rename(os.path.join(args.download_dir,'Jogging'),os.path.join(args.download_dir,'Jogging-2'))
    # os.rename(os.path.join(args.download_dir,'Skating2'),os.path.join(args.download_dir,'Skating2-1'))
    # os.rename(os.path.join(args.download_dir,'Skating2'),os.path.join(args.download_dir,'Skating2-2'))
    # os.rename(os.path.join(args.download_dir,' Human4'),os.path.join(args.download_dir,'Human4-2'))
