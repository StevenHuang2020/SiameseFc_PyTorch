...
def genPredict_MOT17():
    ...
    predPpath = base + '\\predBoxFiles'   
    createPath(predPpath)
        
    imgsAll = getFileList(imgesPath)
    #print('imgsAll=\n', imgsAll)

    gtFlies = getFileList(base, 'txt')
    for i, gt in enumerate(gtFlies):
        ...
        boxFile = predPpath + '\\' + fileName + '_pred.txt'
